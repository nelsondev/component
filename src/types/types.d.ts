...
export interface ComponentContext {
  ...
  /**
   * Define variant style mixes and automatically create variant prop
   * @param mixList Array of variant configurations
   * @returns Proxy object that resolves to appropriate CSS classes
   */
  defineMixes(mixList: VariantMix[]): {
    toString(): string;
    get(variantName: string): string;
  };
